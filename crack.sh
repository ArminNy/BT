...
version=$(curl -Ss --connect-timeout 12 -m 2 https://api.bt.sb/api/panel/getLatestOfficialVersion)
...
# 调用接口获取统计信息
response=$(curl -s "https://tj.bt.sb/api/count?param=aapanel&token=6920626369b1f05844f5e3d6f93b5f6e")
# 检查 Python 版本
